	...
	<div id="page-header" class="hfeed site"><?php
					...
					<div class="head-container">
						<div class="container">
							<div class="sixteen columns">
								<h1 style="border: 0;clip: rect(0 0 0 0);height: 1px;margin: -1px;overflow: hidden;padding: 0;position: absolute;width: 1px;">Coworking Braine L'alleud</h1>
			...
			<?php } else { ?>
					...
					<div class="head-container resp_full_width_menu">
						<div class="container ">
							<div class="sixteen columns plop">
								<h1 style="border: 0;clip: rect(0 0 0 0);height: 1px;margin: -1px;overflow: hidden;padding: 0;position: absolute;width: 1px;">Coworking Braine L'alleud</h1>
								<header id="masthead" class="site-header" role="banner">
									<?php 	
										if (fruitful_is_social_header()) { 
